    ...
    <div class="col-12">
        ...
        <div class="row">
            <div class="col-6 d-flex justify-content-start">
                <button id="saisonPrecedentBtn" class="btn boutton-secondary px-12">Precedent</button>
            </div>
            <div class="col-6 d-flex justify-content-end">
                <button id="saisonSuivantBtn" class="btn boutton-secondary px-12">Suivant</button>
            </div>
        </div>
        <!-- #/ Navigation buttons -->
    </div>
