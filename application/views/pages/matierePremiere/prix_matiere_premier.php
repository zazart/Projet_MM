<section class="section">
    <div class="row justify-content-center">
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" id="prixInsertForm">
                        ...
                        <div class="col-12">
                            ...
                            <input type="number" name="prix" class="form-control" id="prix" value="<?php if (isset($prix_matiere['prix'])) {
                                                                                                        echo $prix_matiere['prix'];
                                                                                                    } ?>">
                            <p class="text-danger" id="prixError"></p>
                        </div>
                        <div class="col-12">
                            <label for="inputNanme4" class="form-label">Date</label>
                            <input type="Date" class="form-control" id="date" name="date" value="<?php if (isset($prix_matiere['dateprix'])) {
                                                                                                        echo $prix_matiere['dateprix'];
                                                                                                    } ?>">
        ...
        <?php if (!isset($prix_matiere['id_prixmatierepremier'])) { ?>
            <div class="col-lg-4">
                <div class="card">
                    <img src="<?php echo (base_url("assets/img/prixmatiere.jpg")) ?>" class="card-img-top">
                ...
                if (response.success) {
                    ...
                    $('#prixdata tbody').on('click', '.img-supprimer', function() {
                        ...
                        swal({
                            ...
                            if (isOkay) {
                                var url =
                                    "<?php echo base_url("Matiere_premier/drop_prix_matier_permier") ?>";
                                $.post(url, {
                                    id: id
                                }, function(data) {
                                    swal({
                            ...
                            swal({
                                ...
                                if (isOkay) {
                                    window.location.href =
                                        "<?php echo base_url("Matiere_premier/prixmatierepremier"); ?>";
                                }
                            });
                        } else {
