...
class Production_Model extends CI_Model
{
    ...
    public function get_all_production_saison($year = null)
    {
        ...
        $sql =
            "SELECT 
                m.id_matierepremier, m.nom, SUM(p.quantitebrut) as quantitebrut, SUM(p.quantiteproduit) as quantiteproduit
            FROM 
                production as p 
            JOIN 
