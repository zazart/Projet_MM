...
ALTER SEQUENCE Poste_id_poste_seq RESTART WITH 1;
ALTER SEQUENCE Employe_id_employe_seq RESTART WITH 1;


copy poste(nom, montant_salaire)
from 'E:\poste.csv' delimiter ';'
CSV HEADER;

copy employe(embauche, debauche, nom, email, telephone, adresse, id_genre, id_poste)
from 'E:\employe.csv' delimiter ';'
CSV HEADER;