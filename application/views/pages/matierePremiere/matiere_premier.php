          ...
          ?>
                    ...
                    <form class="row g-3" id="matiereInsertForm">
                        <input type="hidden" name="id"
                            value="<?php echo isset($matiere['id_matierepremier']) ? $matiere['id_matierepremier'] : ''; ?>">

                        <div class="col-12">
                            <label for="matierepremier" class="form-label">Nom</label>
                            <input id="inputName" type="text" class="form-control" name="matierepremier" value="<?php if (isset($matiere['nom'])) {
                                                                                                    echo $matiere['nom'];
                                                                                                  } ?>">
            ...
            <div class="card">
                ...
                <div class="card-body d-flex justify-content-center mt-3">
                    <button class="boutton boutton-primary" data-bs-toggle="modal"
                        data-bs-target="#verticalycentered">Voir liste des matieres premiers</button>
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <p>Voici les listes de tous les matieres premieres dans le <span
                                        class="color_secondary">projet MM </span>avec ses informations:</p>
                                <div id="valiny">
            ...
            if (xhr2.status === 200) {
                ...
                if (response.success) {
                    ...
                    $('#matiereData tbody').on('click', '.img-modifier', function() {
                        var id = $(this).data('id');
                        var url =
                            "<?php echo base_url("Matiere_premier/edit_matier_permier"); ?>/" +
                            id;
                    ...
                    $('#matiereData tbody').on('click', '.img-supprimer', function() {
                        ...
                        swal({
                            ...
                            if (isOkay) {
                                var url =
                                    "<?php echo site_url("Matiere_premier/drop_matier_permier") ?>";
                                $.post(url, {
                                    id: id
                                }).done(function(data) {
                                    swal({
                        ...
                        swal({
                            ...
                            if (isOkay) {
                                window.location.href =
                                    "<?php echo base_url("Matiere_premier/matiere_premier_insert"); ?>";
                            }
                        });
                    } else {
