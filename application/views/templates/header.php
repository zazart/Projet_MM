  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="matiere-nav" class="<?php echo ($etat == "matierePremiere") ? 'nav-content collapse show' : 'nav-content collapse'; ?>" data-bs-parent="#sidebar-nav">
          <li>
      ...
      <li class="nav-item">
        ...
        <ul id="vente-nav" class="<?php echo ($etat == "vente_commande") ? 'nav-content collapse show' : 'nav-content collapse'; ?>" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?php echo (site_url("vente_commande/vente/statistique")); ?>" <?php if ($activer == "lien_statistique") {
                                                                                      echo 'class="active"';
                                                                                    } ?>>
      ...
      <li class="nav-item">
        ...
        <ul id="depense-nav" class="<?php echo ($etat == "depense") ? 'nav-content collapse show' : 'nav-content collapse'; ?>" data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?php echo (base_url("depense/formulaire")) ?>" <?php if ($activer == "formulaire_depense") {
                                                                        echo 'class="active"';
                                                                      } ?>>
          ...
          <li>
            <a href="<?php echo (base_url("depense/journal")) ?>" <?php if ($activer == "lien_journal") {
                                                                    echo 'class="active"';
                                                                  } ?>>
