                ...
                <form id="depenseForm" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <select class="form-select" name="id_Categorie" id="id_Categorie" required>
                            ...
                            <option value="<?php echo $item['id_sub_comptes']; ?>"><?php echo $item['description']; ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                        </select>
    ...
    <div class="col-lg-4">
        <div class="card" id="">
            ...
            <div class="card-body d-flex justify-content-center mt-3">
                <button id="viewBtn" class="boutton boutton-primary" data-bs-toggle="modal"
                    data-bs-target="#verticalycentered">Voir liste des depenses</button>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <p>Voici les listes de tous les depenses dans le <span class="color_secondary">projet MM
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    ...
                    if (response.success) {
                        ...
                        const categories_array = var_categories.map(categorie => Object.values(
                            categorie));
                        categories_array.forEach(categorie => {
                            const optionHtml = "<option value=\"" + categorie[0] + "\">" +
                                categorie[2] + "</option>";
